# Generated by Django 3.2.6 on 2022-04-19 21:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_img', models.ImageField(default='default_playlist.png', null=True, upload_to='cover_images')),
                ...
                ('playlist_follows', models.ManyToManyField(blank=True, related_name='followed_by', to='app.UserPlaylist')),
            ],
            options={
                'ordering': ['-created_on'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_playlist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.userplaylist')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('user_playlist', 'pl_mov_show_id', 'media_type'), name='user_playlist_constraint'),
        ),
        migrations.AddConstraint(
