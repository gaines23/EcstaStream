# Generated by Django 3.2.6 on 2022-05-22 01:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.BooleanField(choices=[(0, 'Open'), (1, 'Restricted')], default=0)),
                ('likes', models.ManyToManyField(default=None, related_name='review_likes', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likes', models.ManyToManyField(default=None, related_name='comment_likes', to=settings.AUTH_USER_MODEL)),
