...
urlpatterns = [
    ...
    path('create-movie-review/<user>/<movieid>/<media_type>', views.create_movie_review, name='create-movie-review'),
    path('edit-movie-review/<user>/<movieid>/<media_type>', views.edit_movie_review, name='edit-movie-review'),
    path('movie-review/<user>/<movieid>/<media_type>', views.movie_review_details, name='movie-review-details'),
    path('edit-playlist/<user>/<title>', views.edit_user_playlist, name='edit_playlist'),
    path('playlist-follow-add/user/<user_playlist_id>/', views.add_pl_follower, name='playlist_follow'),
    #path('playlist-follow-remove/user/<user_playlist_id>/<id>', views.remove_pl_follower, name='remove_follow'),
